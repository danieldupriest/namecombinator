...
namespace NameCombinator
{
    class Dictionary
    {
        ...
        public Dictionary()
        {
            ...
            String[] lines = wordsSource.Split('\n');
        ...
        public List<String> GetWordsBeginningWith(String pattern)
        {
        ...
        public List<String> GetWordsEndingWith(String pattern)
        {
            List<String> results = new List<String>();
            int length = pattern.Length;
            if (length < 1)
            ...
            foreach (String word in words)
            {
                ...
                for (int i = 0; i < length; ++i)
                {
                    if (word[word.Length - 1 - i] != pattern[length - 1 - i])
                    {
                        match = false;
                        break;
                    }
        ...
        //public List<String> GetWordsOverlapping

        /// Word list compiled by John Lawler: http://www-personal.umich.edu/~jlawler/wordlist.html
        private String wordsSource = @"a
a-horizon
a-ok
aardvark
aardwolf
